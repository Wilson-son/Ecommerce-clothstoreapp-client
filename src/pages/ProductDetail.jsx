  ...
  return (
    <div className="mb-1">
      ...
      >
        ...
        <span className="text-gray-400 text-base leading-none select-none">
          {open ? "−" : "+"}
        </span>
      </button>
      {open && children}
...
export default function ProductDetail() {
  ...
  const images = product?.images?.length
    ...
    : [PLACEHOLDER];
  const activeImg = imgErrors[selectedImg]
    ? PLACEHOLDER
    : (images[selectedImg] ?? PLACEHOLDER);
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 px-6 py-6 border-t lg:border-t-0 lg:border-l border-gray-100">
              ...
              <div className="flex gap-2 mb-5 flex-wrap">
                {sizes.map((s) => (
                  <button
                    ...
                    style={{
                      background: selectedSize === s ? "#111" : "#f3f4f6",
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <span
                  className={`text-xs font-medium ${product.countInStock > 0 ? "text-green-600" : "text-red-500"}`}
                >
